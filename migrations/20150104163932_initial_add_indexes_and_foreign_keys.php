...
ONE-TIME Modification of already existing tables:

ALSO: Remove Indexes, FKs on Subscriptions

ALTER TABLE AuditLogs MODIFY `AuditLogId` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE AuditLogs MODIFY `UserId` int(11) NOT NULL;

ALTER TABLE Builds MODIFY `UserId` int(11) DEFAULT NULL;
ALTER TABLE Builds MODIFY `ConsumerId` int(11) DEFAULT NULL;
ALTER TABLE Builds MODIFY `RepositoryId` int(11) NOT NULL;
ALTER TABLE Builds MODIFY `EnvironmentId` int(11) NOT NULL;

ALTER TABLE Consumers MODIFY `ConsumerId` int(11) NOT NULL AUTO_INCREMENT;

ALTER TABLE Deployments MODIFY `DeploymentId` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE Deployments MODIFY `RepositoryId` int(11) NOT NULL;
ALTER TABLE Deployments MODIFY `ServerId` int(11) NOT NULL;

ALTER TABLE Environments MODIFY `EnvironmentId` int(11) NOT NULL AUTO_INCREMENT;

ALTER TABLE Groups MODIFY `GroupId` int(11) NOT NULL AUTO_INCREMENT;

ALTER TABLE Pushes MODIFY `UserId` int(11) DEFAULT NULL;
ALTER TABLE Pushes MODIFY `ConsumerId` int(11) DEFAULT NULL;
ALTER TABLE Pushes MODIFY `BuildId` char(40) NOT NULL;
ALTER TABLE Pushes MODIFY `DeploymentId` int(11) DEFAULT NULL;
-- ALTER TABLE Pushes MODIFY `RepositoryId` int(11) DEFAULT NULL;

ALTER TABLE Repositories MODIFY `RepositoryId` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE Repositories MODIFY `GroupId` int(11) NOT NULL;

ALTER TABLE Servers MODIFY `ServerId` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE Servers MODIFY `EnvironmentId` int(11) NOT NULL;

ALTER TABLE Tokens MODIFY `TokenId` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE Tokens MODIFY `UserId` int(11) DEFAULT NULL;
ALTER TABLE Tokens MODIFY `ConsumerId` int(11) DEFAULT NULL;
