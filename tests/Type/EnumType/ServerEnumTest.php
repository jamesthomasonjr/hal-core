...
class ServerEnumTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSQLDeclaration()
    {
        ...
        $expected = "ENUM('rsync', 'elasticbeanstalk', 'ec2', 's3') COMMENT '(DC2Type:serverenum)'";
    ...
    public function testConvertToDBValue()
    {
        ...
        $actual = $type->convertToDatabaseValue('elasticbeanstalk', $this->platform);
        $this->assertSame('elasticbeanstalk', $actual);
    }
